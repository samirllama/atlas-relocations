...
import DachshundInBox from "@/public/images/dachshund-in-box.jpg"
...
export default function Testimonials() {
  ...
  const items: Item[] = [
    ...
    },
    {
      img: DachshundInBox,
      quote:
        "As a busy professional, I don't have a lot of time to devote to packing. But with this Atlas, I have seen amazing results! The team is efficient and effective!",
      name: "Jeff Kahl",
